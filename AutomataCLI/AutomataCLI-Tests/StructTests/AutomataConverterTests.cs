...
namespace AutomataCLI_Tests.StructTests {
    ...
    public class AutomataConverterTests {
        [TestMethod]
        public void TestConvertion_NDFA_To_DFA_0() {
            /*
             *      L = {a,b}*{a}{a,b}{a,b} (AFN)
             */
        ...
        [TestMethod]
        public void TestConvertion_NDFAe_To_DFA_0() {
            /*
        ...
        [TestMethod]
        public void TestConvertion_NDFAe_To_DFA_1() {
            /*
             *      L = {a}{a,b}* (AFNe)
             */
        ...
        [TestMethod]
        public void TestConvertion_NDFAe_To_DFA_2() {
            /*
             *      L = {a}{a,b}* (AFNe)
             */
